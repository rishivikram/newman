        ...
        _.forEach(eventsToTrack, function (event) {
            ...
            emitter.on(event, function (err, o) {
                ...
                // assertion errors need to know which assertion in the test was this
                    ...
                    // If the error has come from the aggregated legacy `tests` object, ensure that the actual test name
                    // reaches the reports, and therefore the user
                    (_.get(o.error, 'type') === 'Error') && (err.message = o.assertion);
